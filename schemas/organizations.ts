...
export const OrganizationConfigurationSchema = z.object({
  recursos: z.object({
    ...
    campanhas: z.object({
      ...
      limiteAtivas: z
        .number({ invalid_type_error: "Tipo não válido para o limite de campanhas ativas." })
        .nullable(),
    }),
    ...
    hubAtendimentos: z.object({
      acesso: z.boolean({
        invalid_type_error:
          "Tipo não válido para o acesso aos recursos de atendimentos via WhatsApp Hub.",
      }),
      limiteAtendentes: z
        .number({
    ...
    relatoriosWhatsapp: z.object({
      acesso: z.boolean({
        invalid_type_error:
          "Tipo não válido para o acesso aos recursos de relatórios via WhatsApp.",
      }),
    }),
    iaDicas: z.object({
      acesso: z.boolean({
      ...
      limiteSemanal: z
        .number({ invalid_type_error: "Tipo não válido para o limite de dicas de IA por semana." })
        .nullable(),
    }),
...
export const OrganizationSchema = z.object({
  ...
  logoUrl: z
    .string({ invalid_type_error: "Tipo não válido para a url do logo da organização." })
    .optional()
    .nullable(),
  telefone: z
  ...
  // Location
  localizacaoCep: z
    .string({ invalid_type_error: "Tipo não válido para o CEP da organização." })
    .optional()
    .nullable(),
  localizacaoEstado: z
    .string({ invalid_type_error: "Tipo não válido para o estado da organização." })
    .optional()
    .nullable(),
  localizacaoCidade: z
    .string({ invalid_type_error: "Tipo não válido para a cidade da organização." })
    .optional()
    .nullable(),
  localizacaoBairro: z
    .string({ invalid_type_error: "Tipo não válido para o bairro da organização." })
    .optional()
    .nullable(),
  localizacaoLogradouro: z
    .string({ invalid_type_error: "Tipo não válido para o logradouro da organização." })
    .optional()
    .nullable(),
  localizacaoNumero: z
    .string({ invalid_type_error: "Tipo não válido para o número da organização." })
    .optional()
    .nullable(),
  localizacaoComplemento: z
    .string({ invalid_type_error: "Tipo não válido para o complemento da organização." })
    .optional()
    .nullable(),

  // Onboarding + Marketing + Commercial Data (for us)
  atuacaoNicho: z
    .string({ invalid_type_error: "Tipo não válido para o nicho de atuação da organização." })
    .optional()
    .nullable(),
  atuacaoCanais: z
    .string({ invalid_type_error: "Tipo não válido para os canais de atuação da organização." })
    .optional()
    .nullable(),
  ...
  plataformasUtilizadas: z
    ...
    .nullable(),
  origemLead: z
    .string({ invalid_type_error: "Tipo não válido para a origem dos leads da organização." })
    .optional()
    .nullable(),

  assinaturaPlano: z
    .string({ invalid_type_error: "Tipo não válido para o plano de assinatura da organização." })
    .optional()
    .nullable(),
  dadosViaERP: z
    .boolean({
...
export const OrganizationMemberPermissionsSchema = z.object({
  empresa: z.object({
    visualizar: z.boolean({
      ...
      invalid_type_error:
        "Tipo não válido para a permissão de visualização das configurações da empresa.",
    }),
    editar: z.boolean({
      required_error: "Permissão de edição das configurações da empresa não informada.",
      invalid_type_error:
        "Tipo não válido para a permissão de edição das configurações da empresa.",
    }),
  }),
  resultados: z.object({
    escopo: z
  ...
  atendimentos: z.object({
    ...
    receberTransferencias: z
      .boolean({
        ...
        invalid_type_error:
          "Tipo não válido para a permissão de recebimento de transferências de atendimentos.",
      })
      .optional()
      .nullable(),
  }),
...
export const OrganizationMemberSchema = z.object({
  ...
  usuarioVendedorId: z
    .string({ invalid_type_error: "Tipo não válido para o ID do vendedor do usuário." })
    .optional()
    .nullable(),
...
export const OrganizationMembershipInvitationSchema = z.object({
  ...
  vendedorAplicavel: z
    .boolean({
      invalid_type_error:
        "Tipo não válido para se o vendedor deve ser aplicado ao convite de membro da organização.",
    })
    .default(false),
  vendedorId: z
    .string({
      invalid_type_error:
        "Tipo não válido para o ID do vendedor do convite de membro da organização.",
    })
    .optional()
    .nullable(),
  permissoes: OrganizationMemberPermissionsSchema,
  ...
  dataEfetivacao: z
    .string({
      invalid_type_error:
        "Tipo não válido para a data de efetivação da convite de membro da organização.",
    })
    .optional()
    .nullable()
    .transform((val) => (val ? new Date(val) : null)),
  dataExpiracao: z
    .string({
      invalid_type_error:
        "Tipo não válido para a data de expiração da convite de membro da organização.",
    })
    .datetime({
...
export type TOrganizationMembershipInvitation = z.infer<
  typeof OrganizationMembershipInvitationSchema
>;
...
export type TOrganizationMembershipInvitationState = z.infer<
  typeof OrganizationMembershipInvitationStateSchema
>;
