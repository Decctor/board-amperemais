...
export const MonthControlInformation = z.object({
	...
	investimento: z.number({
		required_error: "Valor de investimento não informado.",
		invalid_type_error: "Tipo não válido para o valor de investimento.",
	}),
});
...
type TMarketingControlDTO = TMarketingControl & { _id: string };
