...
export type TOrganizationMembershipInvitationEntity =
  typeof organizationMembershipInvitations.$inferSelect;
export type TNewOrganizationMembershipInvitationEntity =
  typeof organizationMembershipInvitations.$inferInsert;
