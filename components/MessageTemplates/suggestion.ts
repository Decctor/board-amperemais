import { type TMessageTemplateVariable, MessageTemplateVariables } from "@/lib/message-templates";
...
export function createSuggestion(variables: TMessageTemplateVariable[]) {
	return {
...
export default createSuggestion(MessageTemplateVariables);
