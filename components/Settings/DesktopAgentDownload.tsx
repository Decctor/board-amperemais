...
export default function DesktopAgentDownload() {
	...
	return (
		<div className="flex w-full flex-col gap-3 rounded-2xl border border-border p-4 md:flex-row md:items-center md:justify-between">
			<div className="flex items-start gap-3">
				...
				<div className="flex flex-col gap-0.5">
					...
					<p className="text-xs text-muted-foreground">
						Instale no computador da loja e cole o código de ativação gerado aqui. O agente imprime cupons e etiquetas em segundo plano.
					</p>
				</div>
			</div>
