	...
	return (
		<div className="relative overflow-hidden rounded-2xl bg-brand px-6 py-10 sm:px-10 sm:py-14">
			...
			<div className="relative flex flex-col gap-4">
				<h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-brand-foreground">Explore a comunidade do RecompraCRM</h1>
				<p className="text-sm sm:text-base text-brand-foreground/80 max-w-lg">Acesse cursos e materiais exclusivos para impulsionar seu conhecimento.</p>
				<div className="mt-2 w-full max-w-md relative group">
					...
					<div className="relative flex items-center bg-background rounded-lg border border-transparent shadow-sm w-full">
