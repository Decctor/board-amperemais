  ...
  return (
    <div className="border-b border-gray-300 shadow-sm rounded-bl rounded-br w-full flex flex-col gap-2 p-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <Link href="/analise-rfm">
              <h1 className={cn('text-sm font-bold text-primary px-2 py-1 rounded-lg', pathname == '/analise-rfm' ? 'bg-primary text-white' : 'text-primary')}>
                Análise RFM
              </h1>
            </Link>
          </div>
      ...
      <div className="flex lg:hidden items-center justify-center gap-2 flex-wrap">
        ...
        <Link href="/analise-rfm">
          <h1 className={cn('text-xs font-bold text-primary px-2 py-1 rounded-lg', pathname == '/analise-rfm' ? 'bg-primary text-white' : 'text-primary')}>
            Análise RFM
          </h1>
        </Link>
      </div>
