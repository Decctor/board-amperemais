				...
				<div className="w-full flex flex-col gap-2">
					...
					<div className="w-full flex flex-col gap-1.5">
						<div className="w-full flex items-center gap-1.5">
							...
							<h3 className="text-sm font-semibold tracking-tighter text-foreground/80">TÍTULO</h3>
						...
						<div className="w-full flex items-center gap-1.5">
							...
							<h3 className="text-sm font-semibold tracking-tighter text-foreground/80 shrink-0">PROBABILIDADE</h3>
							{probabilityTier ? (
				...
				<div className="w-full flex flex-col gap-2">
					...
					<div className="w-full flex flex-col gap-1.5">
						...
						<div className="w-full flex items-center gap-1.5">
							...
							<h3 className="text-sm font-semibold tracking-tighter text-foreground/80">CNPJ</h3>
						...
						<div className="w-full flex items-center gap-1.5">
							...
							<h3 className="text-sm font-semibold tracking-tighter text-foreground/80">SITE</h3>
				...
				<div className="w-full flex flex-col gap-2">
					...
					<div className="w-full flex flex-col gap-1.5">
						...
						<div className="w-full flex items-center gap-1.5">
							...
							<h3 className="text-sm font-semibold tracking-tighter text-foreground/80">CARGO</h3>
