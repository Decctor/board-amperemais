...
export default function CashbackProgramsRedemptionLimitBlock({ cashbackProgram, updateCashbackProgram }: CashbackProgramsRedemptionLimitBlockProps) {
	return (
		<ResponsiveMenuSection title="LIMITE DE RESGATE" icon={<Shield className="h-4 min-h-4 w-4 min-w-4" />}>
			<div className="w-full flex flex-col gap-1">
				<p className="text-sm font-medium text-muted-foreground">
					Define abaixo, se aplicável, um limite máximo de resgate por transação. Se FIXO, será o valor absoluto máximo. Se PERCENTUAL, será a porcentagem
					máxima do valor da compra.
				</p>
			</div>
