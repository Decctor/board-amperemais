...
export default function TemplateGeneral({ template, updateTemplate, blockNameChange }: TemplateGeneralProps) {
	return (
		<ResponsiveMenuSection title="INFORMAÇÕES BÁSICAS" icon={<LayoutGrid size={15} />}>
			{blockNameChange && (
				<p className="w-fit self-center bg-orange-100 text-orange-500 text-xs rounded-lg px-2 py-1">
					⚠️ Nome do template não pode ser alterado após criado.
				</p>
			)}
