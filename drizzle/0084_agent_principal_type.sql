...
-- Aplicar com: npx tsx ./scripts/apply-sql-migration.ts drizzle/0084_agent_principal_type.sql
-- Idempotente (IF NOT EXISTS).
--
-- SEPARADO DA 0085 DE PROPÓSITO: `ALTER TYPE ... ADD VALUE` não pode ser usado na mesma
