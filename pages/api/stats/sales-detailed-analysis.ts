...
const getSalesDetailedAnalysisHandler: NextApiHandler<TGetSalesDetailedAnalysisOutput> = async (req, res) => {
...
export default apiHandler({ POST: getSalesDetailedAnalysisHandler });
