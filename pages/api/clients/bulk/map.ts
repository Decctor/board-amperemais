...
import {
	...
	BulkClientsMapInputSchema,
	BulkClientsMapOutputSchema,
	type TBulkClientsMapOutput,
...
const mapClientsSheetRoute: NextApiHandler<TMapClientsSheetOutput> = async (req, res) => {
