		...
		return (
			<Section.Root>
				<Section.Header>
					...
					<Section.Title>LOJA</Section.Title>
				</Section.Header>
				<Section.Body>
						...
						{detailsQuery.isLoading ? (
							...
							<>
								<div className="w-full flex flex-col gap-1.5">
									<DataList.Line icon={<Hash className="w-4 h-4" />} label="ID" value={merchant.id} />
									<DataList.Line icon={<Tag className="w-4 h-4" />} label="TIPO" value={merchant.tipo ?? "NÃO INFORMADO"} />
									<DataList.Line icon={<MapPin className="w-4 h-4" />} label="ENDEREÇO" value={addressLine ?? "NÃO INFORMADO"} />
									<DataList.Line icon={<MapPin className="w-4 h-4" />} label="CEP" value={merchant.endereco?.cep ?? "NÃO INFORMADO"} />
								</div>
