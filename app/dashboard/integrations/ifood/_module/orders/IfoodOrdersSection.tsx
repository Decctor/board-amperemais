...
type IfoodOrdersSectionProps = {
	canManage: boolean;
};

/**
 * Seção de pedidos: lista os pedidos iFood ingeridos (tabela sales) com as ações do ciclo de vida.
 ...
 */
export function IfoodOrdersSection({ canManage }: IfoodOrdersSectionProps) {
