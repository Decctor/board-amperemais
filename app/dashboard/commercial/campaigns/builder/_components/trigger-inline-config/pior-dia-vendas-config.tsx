	...
	return (
		<div className="flex w-full flex-col gap-3 rounded-lg border border-primary/10 bg-card p-4">
			<p className="text-xs text-muted-foreground">
				A campanha será disparada automaticamente no dia da semana com menor volume de vendas, calculado pelas últimas 8 semanas
				de histórico. Você poderá ajustar o atraso e o bloco de horário na próxima etapa.
			</p>
