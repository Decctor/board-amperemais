...
import { BulkSaleCanonicalFieldSchema, type TBulkSalesMappingDefinition } from "@/state-hooks/use-bulk-create-sales";
...
type BulkInsertMappingStageProps = {
	...
	onUpdateMapping: (field: (typeof BulkSaleCanonicalFieldSchema.options)[number], sourceColumn: string | null) => void;
	onRemap: () => void;
	onReset: () => void;
	onContinue: () => void;
};
