...
import CheckoutPanel from "../../new-sale/components/CheckoutPanel";
import ProductBuilderModal from "../../new-sale/components/ProductBuilderModal";
import CategoriesBar from "../../new-sale/components/composition/CategoriesBar";
import PaginationBlock from "../../new-sale/components/composition/PaginationBlock";
import ProductsGridBlock from "../../new-sale/components/composition/ProductsGridBlock";
import SearchBlock from "../../new-sale/components/composition/SearchBlock";
import ViewModeToggle, { type ProductViewMode } from "../../new-sale/components/composition/ViewModeToggle";
				...
				<div className="w-full max-w-lg rounded-2xl border bg-card p-6 flex flex-col gap-4 items-center text-center">
					...
					<div className="flex items-center gap-2">
						{saleForEdit.editabilidade.rascunho ? (
							<Button asChild>
								<Link href={`/dashboard/commercial/sales/checkout/${saleId}`}>ABRIR CHECKOUT DO RASCUNHO</Link>
							</Button>
						) : null}
						<Button variant="outline" asChild>
							<Link href={`/dashboard/commercial/sales/${saleId}`}>VER DETALHES DA VENDA</Link>
						</Button>
					</div>
				</div>
			</div>
