                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm font-semibold leading-tight">
                            ...
                            {sale.transacoesCashback.length === 1 ? "movimento" : "movimentos"}
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex items-center gap-2">
              <Avatar className="w-6 h-6">
                ...
                <AvatarFallback className="text-[0.6rem]">
                  {formatNameAsInitials(sale.vendedor.nome)}
                </AvatarFallback>
              </Avatar>
              <div className="flex flex-col">
                <span className="text-[0.6rem] text-muted-foreground font-medium uppercase leading-none">
                  Vendedor
                </span>
          ...
          {sale.parceiro && (
            <div className="flex items-center gap-2">
              <Avatar className="w-6 h-6">
                ...
                <AvatarFallback className="text-[0.6rem]">
                  {formatNameAsInitials(sale.parceiro.nome)}
                </AvatarFallback>
              </Avatar>
              <div className="flex flex-col">
                <span className="text-[0.6rem] text-muted-foreground font-medium uppercase leading-none">
  ...
  return (
    <div className="flex items-center justify-center lg:justify-end flex-wrap gap-2">
      ...
      {filters.saleNatures && filters.saleNatures.length > 0 && (
        <FilterTag
          label="NATUREZAS"
          value={filters.saleNatures.join(", ")}
          onRemove={() => updateFilters({ saleNatures: [] })}
        />
      )}
          ...
          <div className="flex h-full flex-col gap-y-4 overflow-y-auto overscroll-y-auto p-2 scrollbar-thin scrollbar-track-primary/10 scrollbar-thumb-primary/30">
            <div className="flex w-full flex-col gap-2">
              ...
              <MultipleSelectInput
                ...
                handleChange={(value) =>
                  setQueryParamsHolder((prev) => ({ ...prev, saleNatures: value as string[] }))
                }
              ...
              <MultipleSelectInput
                ...
                handleChange={(value) =>
                  setQueryParamsHolder((prev) => ({ ...prev, sellersIds: value as string[] }))
                }
              ...
              <MultipleSelectInput
                ...
                handleChange={(value) =>
                  setQueryParamsHolder((prev) => ({ ...prev, partnersIds: value as string[] }))
                }
