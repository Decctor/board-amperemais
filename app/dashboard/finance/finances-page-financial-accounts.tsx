...
type FinancesAccountsViewProps = {
	canCreateAccounts?: boolean;
	canEditAccounts?: boolean;
};

export default function FinancesAccountsView({ canCreateAccounts = false, canEditAccounts = false }: FinancesAccountsViewProps) {
...
function AccountCard({ account, statsPeriodAfter, statsPeriodBefore, canEdit, onEdit }: AccountCardProps) {
...
function AccountCardChart({ accountId, accountType, startDate, endDate }: AccountCardChartProps) {
