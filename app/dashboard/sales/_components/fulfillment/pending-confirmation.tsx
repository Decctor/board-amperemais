...
function PendingConfirmationMenu({
	...
	return (
		<ResponsiveMenuV2
			menuTitle="PEDIDOS A CONFIRMAR"
			menuDescription={`Pedidos do iFood aguardando confirmação. O iFood cancela pedidos não confirmados em ${IFOOD_CONFIRMATION_SLA_MINUTES} minutos.`}
