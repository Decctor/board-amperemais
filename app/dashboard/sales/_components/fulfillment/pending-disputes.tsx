...
function PendingDisputesMenu({
	...
	return (
		<ResponsiveMenuV2
			menuTitle="DISPUTAS DE CANCELAMENTO"
			menuDescription="O cliente ou o iFood pediu o cancelamento destes pedidos. Responda antes do prazo — sem resposta, o iFood decide sozinho."
