...
`}</style>
			{/* Banner Topo */}
			<div className="bg-gradient-to-r from-orange-500 to-orange-600 text-center py-2 px-4 text-sm font-medium text-white">
...
<Link href="/" className="flex items-center gap-3 group">
  <Image
  src="/brand/logo-recompra-horizontal.png"// ✅ troque pelo nome do seu arquivo	
  alt="RecompraCRM"
  width={200}
  height={80}
  priority
/>
  ...
  <ArrowUp className="w-3 h-3 text-orange-500 opacity-0 group-hover:opacity-100 transition-opacity" />
</Link>
  ...
  <MessageCircle className="w-5 h-5 text-white" />
							...
							<Link href="/agenda-reuniao">
								<Button
									...
									style={{ color: '#ffffff', backgroundColor: 'transparent', borderColor: 'rgba(255,255,255,0.2)' }}
								>
...
<div className="absolute inset-0 overflow-hidden pointer-events-none">
  {/* Glow suave laranja */}
  <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-orange-500/10 blur-3xl rounded-full" />
  ...
  <div className="absolute top-1/4 left-1/4 w-96 h-96 border border-orange-500/10 rounded-full blur-3xl" />
  <div className="absolute bottom-1/4 right-1/4 w-96 h-96 border border-orange-500/10 rounded-full blur-3xl" />
</div>
				<div className="relative container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center z-10">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<Link href="/agenda-reuniao">
							<Button
								size="lg"
								className="!bg-gradient-to-r !from-orange-500 !to-orange-600 hover:!from-orange-600 hover:!to-orange-700 !text-white !border-0 !shadow-xl px-8 h-14 text-base font-semibold"
								style={{ 
									background: 'linear-gradient(to right, #f97316, #ea580c)',
									color: '#ffffff',
									border: 'none'
						...
						<Link href="/agenda-reuniao">
							<Button
								size="lg"
								variant="outline"
								className="!border-orange-500/50 !text-white hover:!bg-orange-500/10 hover:!border-orange-500 !bg-transparent px-8 h-14 text-base font-semibold"
								style={{ 
          ...
          >
				...
				<div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					<div className="grid md:grid-cols-3 gap-10">
						<div className="space-y-4 text-center">
							<div className="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-orange-500/10 border border-orange-500/20">
								<CheckCircle2 className="w-8 h-8 text-orange-500" />
							</div>
							<h3 className="text-xl md:text-2xl font-semibold text-white">1. Conecte seus dados</h3>
							<p className="text-white/60 leading-relaxed">
								Importe suas bases e integre seus canais de vendas e atendimento em minutos.
							</p>
						</div>
						...
						<div className="space-y-4 text-center">
							...
							<p className="text-white/60 leading-relaxed">
								Tenha visão completa das suas vendas, funil e performance comercial.
							</p>
						</div>
						...
						<div className="space-y-4 text-center">
							...
							<p className="text-white/60 leading-relaxed">
								Crie fluxos automáticos de resposta e campanhas inteligentes com IA.
							</p>
						</div>
					</div>
				</div>
			...
			<section className="py-20 md:py-28 bg-zinc-950">
				<div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
						<Card className="bg-black border-white/10 hover:border-orange-500/30 transition-colors">
							<div className="p-6 space-y-3">
								<BarChart3 className="w-6 h-6 text-orange-500" />
								<h4 className="font-semibold text-lg text-white">Business Intelligence</h4>
								<p className="text-sm text-white/60">
									Dashboards e insights para decisões rápidas.
								</p>
							</div>
						</Card>

						<Card className="bg-zinc-900 border-white/10 hover:border-orange-500/30 transition-colors">
							<div className="p-6 space-y-3">
								<MessageCircle className="w-6 h-6 text-orange-500" />
								<h4 className="font-semibold text-lg text-white">WhatsApp Hub</h4>
								<p className="text-sm text-white/60">
									Atendimento unificado e automações inteligentes.
								</p>
							</div>
						</Card>
						...
						<Card className="bg-zinc-900 border-white/10 hover:border-orange-500/30 transition-colors">
							<div className="p-6 space-y-3">
								...
								<p className="text-sm text-white/60">
									Assistente inteligente com histórico e entrega personalizada.
								</p>
							</div>
						</Card>
						...
						<Card className="bg-zinc-900 border-white/10 hover:border-orange-500/30 transition-colors">
							<div className="p-6 space-y-3">
								...
								<p className="text-sm text-white/60">
									Acúmulo e regras personalizadas.
								</p>
							</div>
						</Card>
						...
						<Card className="bg-zinc-900 border-white/10 hover:border-orange-500/30 transition-colors">
							<div className="p-6 space-y-3">
								...
								<p className="text-sm text-white/60">
									Exportação, análise detalhada e insights estratégicos.
								</p>
							</div>
						</Card>
					</div>
			...
			<section className="py-20 md:py-28 bg-black">
				<div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					<div className="grid md:grid-cols-2 gap-8">
						<blockquote className="p-8 rounded-xl border border-white/10 bg-zinc-900 hover:border-orange-500/30 transition-colors">
							...
							<footer className="mt-6 font-semibold text-sm text-white/60">
								— Empresas do varejo
							</footer>
						</blockquote>
			...
			<section className="relative py-20 md:py-28 bg-gradient-to-b from-[#1a0f08] to-[#0a0a0a] overflow-hidden">
				<div className="absolute inset-0 opacity-10">
					<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-orange-500/20 rounded-full blur-3xl" />
				</div>
				<div className="relative container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center z-10">
					<h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Pronto para crescer?</h2>
					<p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
						Experimente a plataforma que transforma a gestão comercial.
					</p>
				...
				<div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
						<div>
							...
							<p className="text-sm text-white/60">
								Plataforma de otimização de vendas integrada.
							</p>
						</div>
					...
					<div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
						<div className="flex flex-col sm:flex-row items-center justify-between gap-4">
							<p className="text-sm text-white/80 text-center sm:text-left">
								A RecompraCRM agora é uma parceira Wake! Saiba mais sobre no nosso blog.
							</p>
							<div className="flex items-center gap-3">
								<Button
									variant="outline"
								...
								<button className="p-1 hover:bg-white/10 rounded transition-colors" aria-label="Fechar">
