...
// Página otimizada para impressão em PDF (A4, múltiplas folhas). Não faz parte do produto.
...
/* -------------------------------------------------------------------------- */
/*  Marca RecompraCRM (fixa — a proposta é nossa)                             */
/* -------------------------------------------------------------------------- */
...
function SheetFooter({ index, label }: { index: string; label: string }) {
	return (
...
function Kicker({ children, tone = "blue" }: { children: ReactNode; tone?: "blue" | "gold" | "white" }) {
