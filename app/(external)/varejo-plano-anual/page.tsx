...
// Shell de impressão do documento institucional "Recompra no Varejo · Plano Anual".
// Segue o mesmo padrão das propostas comerciais (A4, várias folhas) — o conteúdo
// vive em ./_components/varejo-plano-anual.tsx.

import { Printer } from "lucide-react";
import { BRAND } from "../proposta-personalizada/_components/_shared";
import { VarejoPlanoAnualDocument } from "./_components/varejo-plano-anual";

export default function VarejoPlanoAnualPage() {
