...
export function SaleValueStep({ value, onChange, onSubmit, mode }: SaleValueStepProps) {
			...
			{isKiosk ? (
				<div className="max-w-md mx-auto">
					<VirtualKeyboard
						...
						description="Digite os centavos da direita para a esquerda."
						value={value}
						onChange={onChange}
						quickAdd={VALUE_HELPERS}
						allowClear
