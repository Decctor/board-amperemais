	...
	return (
		<div className="space-y-8 short:space-y-3 animate-in fade-in slide-in-from-bottom-4">
			<div className="text-center space-y-2 short:space-y-0.5">
				<h2 className="text-xl short:text-lg font-extrabold tracking-tight">O que deseja fazer?</h2>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 short:gap-2 max-w-2xl mx-auto">
				<button
					...
					className="group flex flex-col items-center gap-4 short:gap-2 p-8 short:p-4 bg-brand/5 border border-brand/20 rounded-3xl short:rounded-xl hover:border-brand hover:bg-brand/10 transition-all cursor-pointer"
				>
					...
					<div className="text-center">
						<h3 className="font-bold text-lg short:text-sm tracking-tight">Pontuar e obter descontos</h3>
				...
				<button
					...
					className="group flex flex-col items-center gap-4 short:gap-2 p-8 short:p-4 bg-brand-secondary/5 border border-brand-secondary/20 rounded-3xl short:rounded-xl hover:border-brand-secondary hover:bg-brand-secondary/10 transition-all cursor-pointer"
				>
					...
					<div className="text-center">
						<h3 className="font-bold text-lg short:text-sm tracking-tight">Pontuar e resgatar recompensa</h3>
