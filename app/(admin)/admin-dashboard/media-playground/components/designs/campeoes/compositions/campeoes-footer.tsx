...
export function CampeoesFooter({ tokens, padX, logoHeightPx, footerBottomPx, className }: CampeoesFooterProps) {
	const { t } = tokens;

	return (
		<div
			data-design-role="campeoes-footer"
