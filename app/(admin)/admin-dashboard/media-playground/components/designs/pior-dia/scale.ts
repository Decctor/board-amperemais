/** Vertical rhythm vs 1080×1350 reference — same formula as Campeões */
export function getPiorDiaScale(height: number) {
...
export type PiorDiaLayoutTokens = ReturnType<typeof getPiorDiaScale>;
