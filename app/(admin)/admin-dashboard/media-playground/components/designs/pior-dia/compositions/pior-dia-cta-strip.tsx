...
import { PIOR_DIA_CTA_BODY, PIOR_DIA_CTA_BUTTON_LABEL } from "../constants";
import type { PiorDiaLayoutTokens } from "../scale";

type PiorDiaCtaStripProps = {
...
export function PiorDiaCtaStrip({
	tokens,
	ctaLineSize,
	flexDirection,
	buttonFontMultiplier,
	className,
}: PiorDiaCtaStripProps) {
	const { t } = tokens;
	const isColumn = flexDirection === "column";

	return (
		<div
			data-design-role="pior-dia-cta-strip"
