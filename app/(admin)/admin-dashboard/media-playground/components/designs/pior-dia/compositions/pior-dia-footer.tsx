...
export function PiorDiaFooter({ tokens, padX, logoHeightPx, footerBottomPx, className }: PiorDiaFooterProps) {
	const { t } = tokens;

	return (
		<div
			data-design-role="pior-dia-footer"
