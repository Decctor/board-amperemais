 ...
 * Origem: components/Stats/Blocks/CampaignTriggerDistributionBlock.tsx (commit 19d8578).
 *
...
export function CampaignTriggerDistributionBlock({ overall }: CampaignTriggerDistributionBlockProps) {
