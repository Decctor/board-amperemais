 ...
 * Origem: app/dashboard/growth/campaigns/_module/builder/components/stages/stage-review.tsx (commit 19d8578).
 *
 ...
 * A categoria chega por prop (o original lia do contexto de UI).
...
export default function StageReview({ selectedCategory }: StageReviewProps) {
