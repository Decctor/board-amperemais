 ...
 * Origem: app/dashboard/growth/campaigns/_module/builder/components/trigger-inline-config/index.ts (commit 19d8578).
 *
 * Mesmo mapa gatilho → componente, apontando para as cópias estáticas.
