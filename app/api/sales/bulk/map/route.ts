...
const BulkSaleCanonicalFieldSchema = z.enum([
	"clienteNome",
	"clienteTelefone",
	"clienteCpfCnpj",
	"valorTotal",
...
const BulkSalesMappingDefinitionSchema = z.object({
...
const BulkSalesMapInputSchema = z.object({
...
const BulkSalesMapOutputSchema = z.object({
	mappingDefinitions: z.array(BulkSalesMappingDefinitionSchema),
	warnings: z.array(z.string()),
});
type TBulkSalesMapOutput = z.infer<typeof BulkSalesMapOutputSchema>;
...
const mapSalesSheetRoute: PagesRouteHandler<TMapSalesSheetOutput> = async (req, res) => {
