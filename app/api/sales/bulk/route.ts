...
const BulkSaleImportRowSchema = z
	.object({
...
type TBulkSaleImportRow = z.infer<typeof BulkSaleImportRowSchema>;

const BulkCreateSalesInputSchema = z.object({
...
export type TBulkCreateSalesOutput = {
	data: {
...
const bulkCreateSalesRoute: PagesRouteHandler<PostResponse> = async (req, res) => {
