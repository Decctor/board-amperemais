...
async function fetchSalesSimplified(req: PagesRouteRequest, userOrgId: string) {
	const PAGE_SIZE = 50;
...
const getSalesSimplifiedRoute: PagesRouteHandler<{
...
const routeHandlers = {
	POST: getSalesSimplifiedRoute,
	GET: getSalesSimplifiedRoute,
