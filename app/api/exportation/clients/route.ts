...
async function fetchClientExportation(req: PagesRouteRequest, userOrgId: string) {
...
const handleClientsExportation: PagesRouteHandler<{
...
const routeHandlers = {
	POST: handleClientsExportation,
	GET: handleClientsExportation,
