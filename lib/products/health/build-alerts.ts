...
import type { TAbcDistributionItem, TProductPortfolioHealthAlert, TProductWithPeriodMetrics } from "./types";

type TBuildAlertsInput = {
...
export function buildPortfolioHealthAlerts({
	totalProducts,
	activeProducts,
	abcDistribution,
	revenueMetrics,
	marginMetrics,
}: TBuildAlertsInput): TProductPortfolioHealthAlert[] {
	const alerts: TProductPortfolioHealthAlert[] = [];
